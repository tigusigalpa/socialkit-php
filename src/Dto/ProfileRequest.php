...
/**
 * Request DTO for profile endpoints (Twitter, LinkedIn).
 *
 * @see https://docs.socialkit.dev/api-reference/twitter-profile-api
 * @see https://docs.socialkit.dev/api-reference/linkedin-profile-api
 */

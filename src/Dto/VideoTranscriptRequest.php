...
/**
 * Request DTO for video transcript endpoint (direct video file URL).
 *
 * @see https://docs.socialkit.dev/api-reference/video-transcript-api
 */
final class VideoTranscriptRequest
{
